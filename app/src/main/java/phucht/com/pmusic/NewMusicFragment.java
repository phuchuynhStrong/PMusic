 ...
 * {@link OnNewMusicFragmentInteractionListener} interface
...
public class NewMusicFragment extends Fragment {
    ...
    private OnNewMusicFragmentInteractionListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onNewMusicFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnNewMusicFragmentInteractionListener) {
            mListener = (OnNewMusicFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnNewMusicFragmentInteractionListener {
        // TODO: Update argument type and name
        void onNewMusicFragmentInteraction(Uri uri);
    }
}
